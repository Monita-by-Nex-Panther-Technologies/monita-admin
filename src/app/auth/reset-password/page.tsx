        ...
        <div className="bg-white rounded-xl shadow-xl p-6 sm:p-8 border border-gray-100">
          ...
          {success ? (
            <div className="text-center space-y-6">
              ...
              <Link
                href="/auth"
                className="block w-full bg-[#CEEF0A] hover:bg-[#c0df00] text-black font-semibold py-3.5 px-4 rounded-lg transition duration-200 font-poppins shadow-md text-center"
              >
                Go to Login
              </Link>
            </div>
            ...
            <form onSubmit={handleResetPassword} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 p-1.5 rounded-md text-gray-500 hover:bg-gray-100 focus:outline-none"
                    aria-label={
              ...
              <div className="text-center">
                <Link
                  href="/auth"
                  className="text-[#CEEF0A] hover:text-[#c0df00] text-sm font-poppins"
                >
                  Back to Sign In
                </Link>
              </div>
