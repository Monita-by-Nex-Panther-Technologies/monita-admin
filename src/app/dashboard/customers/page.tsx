...
const page = () => {
     const {
        ...
        useEffect(() => {
            ...
            getCustomers({ page: 1, limit: 10 }); // Replace with appropriate values for TransactionQueryParams
          }, []);
        ...
        <div className=' w-full'>
            ...
            <div className="w-full flex flex-row justify-between items-center bg-background p-4 rounded-[8px]">
                ...
                <div className="flex space-x-2">
                    <button
                        className={`py-2 px-4 rounded-lg ${activeTab === "all" ? "bg-[#DDFF00] text-black font-medium" : "bg-white text-gray-600"
                            }`}
                    ...
                    <button
                        className={`py-2 px-4 rounded-lg ${activeTab === "blocked" ? "bg-[#DDFF00] text-black font-medium" : "bg-white text-gray-600"
                            }`}
...
//         const dataToExport =
//             selected.length > 0 ? filteredUsers.filter((user) => selected.includes(user.id)) : filteredUsers

//         if (format === "DOC") {
//             const docContent = dataToExport
//                 .map((u) => `${u.name}\t${u.email}\t${u.kycStatus}\t${u.registrationDate}`)
//                 .join("\n")
...
//                 body: dataToExport.map((user) => [user.name, user.email, user.kycStatus, user.registrationDate]),
//                 startY: 30,
//                 styles: {
//                     fontSize: 10,
//                     cellPadding: 3,
...
//                                 <TableHead className="text-base font-medium">Email Address</TableHead>
//                                 <TableHead className="text-base font-medium">KYC Status</TableHead>
//                                 <TableHead className="text-base font-medium">Registration Date</TableHead>
...
//                                         <span className="px-4 py-2 rounded-md bg-[#E6F7EF] text-[#00A85A]">{user.kycStatus}</span>
//                                     </TableCell>
//                                     <TableCell className="text-base py-6">{user.registrationDate}</TableCell>
//                                     <TableCell>
//                                         <Button
//                                             variant="outline"
