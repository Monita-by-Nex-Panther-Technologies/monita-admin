            ...
            <div className="grid gap-6">
                ...
                <div className="w-full flex flex-row justify-between items-center bg-background p-4 rounded-[8px]">
                    ...
                    <div className="flex flex-row bg-background-alt gap-x-1.5 px-3 py-2 rounded-[8px]">
                        <button className="justify-center items-center bg-primary-light border border-primary text-text-body font-poppins px-4 py-3 w-[186px] rounded-[8px] active:bg-primary-foreground">
                            Today
                        </button>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-sm lg:col-span-2">
                        <div className="w-full flex flex-row justify-between items-center mb-4">
                            ...
                            <div className="flex flex-row bg-background-alt gap-x-1.5 px-3 py-2 rounded-[8px]">
                                <button
                                    className={`justify-center items-center ${activeTab === "Transaction Volume" ? "bg-primary-light border border-primary" : "bg-background"} text-text-body font-poppins px-4 py-2 rounded-[8px]`}
                                    onClick={() => setActiveTab("Transaction Volume")}
                                >
                                    Transaction Volume
                                </button>
                                <button
                                    className={`justify-center items-center ${activeTab === "Transaction Trends" ? "bg-primary-light border border-primary" : "bg-background"} text-text-body font-poppins px-4 py-2 rounded-[8px]`}
                        ...
                        <div className="mt-6">
                            <div className="font-medium text-text-title mb-4 font-poppins">Transaction Volume</div>
                            <div className="h-64">
                                <ResponsiveContainer width="100%" height="100%">
                                    <ComposedChart data={transactionVolumeData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                        <defs>
