...
const ProductNavItem: React.FC<ProductNavItemProps> = ({
    ...
    `}
            >
                <div className={`w-10 h-10 rounded-full flex justify-center items-center ${isActive ? 'bg-white' : 'bg-background-alt'}`}>
...
const PlanHeadder = () => {
    ...
    const categories = [
        { id: 'data', label: 'Data Plan', icon: <Database size={20} />, route: `${basePath}/data-plan` },
