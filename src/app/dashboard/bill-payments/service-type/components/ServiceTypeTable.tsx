    ...
    <div className="overflow-auto relative bg-background rounded-2xl my-6 py-4 flex flex-col gap-5">
      ...
      <Table className="w-full rounded-2xl bg-background p-5">
        <TableHeader className="bg-primary-fade text-muted-foreground">
          <TableRow>
            <TableHead className="text-base font-medium px-8">
              Services
            </TableHead>
            <TableHead className="text-base font-medium text-center">
              Enable / Disable
            </TableHead>
            <TableHead className="text-base font-medium text-right px-8">
              Action
            </TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {services.map((service) => (
            ...
            >
              <TableCell className="text-text-body font-poppins text-base py-6 px-8">
                {service.name}
              </TableCell>
