...
//     // Effect to load brands when service changes
//     useEffect(() => {
//         const loadBrands = async () => {
//             // If selectedServiceId is set, use it; otherwise wait for it to be set
//             if (selectedServiceId) {
//                 try {
//                     const searchState = getSearchState(currentServiceType);
//                     await getBrands(selectedServiceId, 1, 100, searchState.term);
//                 } catch (error: any) {
//                     toast.error("Failed to load brands", {
//                         description: error.message || "An error occurred"
//                     });
//                 }
//             } else {
//                 // If selectedServiceId is not set, try to load based on current service type
//                 // This could be a fallback, but you might want to wait for proper selection
//                 try {
//                     const searchState = getSearchState(currentServiceType);
//                     await getBrands("", 1, 100, searchState.term);
//                 } catch (error: any) {
//                     toast.error("Failed to load brands", {
//                         description: error.message || "An error occurred"
//                     });
...
//         loadBrands();
//     }, [selectedServiceId, currentServiceType, getBrands, getSearchState]);
...
//                 // Save search term for this service type
//                 updateSearchState(currentServiceType, term);
//                 await getBrands(selectedServiceId, 1, 100, term);
//             } catch (error: any) {
//                 toast.error("Search failed", {
//                     description: error.message || "An error occurred"
//                 });
...
//             }
//         }, 500),
//         [selectedServiceId, getBrands, currentServiceType, updateSearchState]
//     );
...
//             // If search term is cleared, fetch all brands
//             if (selectedServiceId) {
//                 getBrands(selectedServiceId, 1, 100, '');
//                 updateSearchState(currentServiceType, '');
//             }
//         }
//     }, [searchTerm, debouncedSearch, getBrands, selectedServiceId, currentServiceType, updateSearchState]);
...
//             // Refresh brands list
//             await getBrands(selectedServiceId, 1, 100, searchTerm);
//         } catch (error: any) {
//             toast.error("Failed to add brand", {
//                 description: error.message || "An error occurred"
//             });
...
//                     Current Service: <span className="font-medium capitalize">{currentServiceType}</span>
//                     {selectedServiceId && <span className="text-xs text-gray-400 ml-2">(ID: {selectedServiceId})</span>}
//                 </span>
//             </div>
