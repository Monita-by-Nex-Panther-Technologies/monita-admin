    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
                                ...
                                <TableRow>
                                    <TableHead className="p-4">
                                        <input
                                            ...
                                            checked={selected.length === filteredUsers.length && selected.length > 0}
                                    ...
                                    <TableHead className="text-base font-poppins text-text-title">Issued Date</TableHead>
                            ...
                            <TableBody>
                                {filteredUsers.map((user) => (
                                    <TableRow key={user.id} className="py-6">
                                        ...
                                        <TableCell className="text-text-body font-poppins text-base py-6">{user.username}</TableCell>
                                        <TableCell className="text-text-body font-poppins text-base py-6">{user.email}</TableCell>
                                        <TableCell className="text-text-body font-poppins text-base py-6">{user.cardType}</TableCell>
                                        <TableCell className="text-text-body font-poppins text-base py-6">
                                            <span
                                                className={`px-2 py-1 rounded-md w-full ${user.status === "Active" ? "status-success" : "status-error"
                                                    }`}
                                            >
                                                {user.status}
                                            </span>
                                        </TableCell>
                                        <TableCell className="text-text-body font-poppins text-base py-6">{user.issuedDate}</TableCell>
                                        <TableCell>
                                            <Button
                                                variant="ghost"
            ...
            <Dialog open={spendingLimitOpen} onOpenChange={setSpendingLimitOpen}>
                <DialogContent className="sm:max-w-md p-0 gap-0">
                    <DialogHeader className="p-6 pb-2">
                        <DialogTitle className="text-xl font-semibold">Set Spending Limit</DialogTitle>

                    </DialogHeader>
                    <div className="border-t border-gray-200 my-2"></div>
                    <div className="p-6">
                        <div className="mb-4">
                            <label className="block text-sm font-medium mb-2">Enter Spending Limit</label>
                            <input
                                type="text"
                                placeholder="Enter"
            ...
            <Dialog open={exchangeRateOpen} onOpenChange={setExchangeRateOpen}>
                <DialogContent className="sm:max-w-md p-0 gap-0">
                    <DialogHeader className="p-6 pb-2">
                        <DialogTitle className="text-xl font-semibold">Set Exchange Rate</DialogTitle>

                    </DialogHeader>
                    <div className="border-t border-gray-200 my-2"></div>
                    <div className="p-6">
                        <div className="mb-4">
                            <label className="block text-sm font-medium mb-2">Provider Exchange Rate</label>
                            <div className="w-full p-3 bg-gray-100 rounded-md">₦2.00</div>
                        </div>
                        <div className="mb-4">
                            <label className="block text-sm font-medium mb-2">Set Exchange Rate</label>
                            <input
                                type="text"
            ...
            <Dialog open={cardFeesOpen} onOpenChange={setCardFeesOpen}>
                <DialogContent className="sm:max-w-md p-0 gap-0">
                    <DialogHeader className="p-6 pb-2">
                        <DialogTitle className="text-xl font-semibold">Set Card Fees</DialogTitle>

                    </DialogHeader>
                    <div className="border-t border-gray-200 my-2"></div>
                    <div className="p-6">
                        <div className="mb-4">
                            <label className="block text-sm font-medium mb-2">Enter Transaction Fee</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-4">
                            <label className="block text-sm font-medium mb-2">Monthly Maintenance Fee</label>
                            <input
                                type="text"
                                placeholder="Enter Fee"
                                className="w-full p-3 border border-gray-300 rounded-md"
                        ...
                        <div className="mb-4">
                            <label className="block text-sm font-medium mb-2">Decline Fee</label>
                            <input
                                type="text"
                                placeholder="Enter Fee"
                                className="w-full p-3 border border-gray-300 rounded-md"
                        ...
                        <div className="mb-4">
                            <label className="block text-sm font-medium mb-2">Foreign Transaction Fee</label>
                            <input
                                type="text"
                                placeholder="Enter Fee"
                                className="w-full p-3 border border-gray-300 rounded-md"
            ...
            <Dialog open={filterTransactionOpen} onOpenChange={setFilterTransactionOpen}>
                <DialogContent className="sm:max-w-md p-0 gap-0">
                    <DialogHeader className="p-6 pb-2">
                        <DialogTitle className="text-xl font-semibold">Filter Transaction</DialogTitle>
