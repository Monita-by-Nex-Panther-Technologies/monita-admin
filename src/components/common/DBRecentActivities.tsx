...
const transactions: Transaction[] = [
    { username: "Adebayo10", id: "102911120111", amount: "₦10,000", type: "Airtime", status: "Successful", date: "Jan 02, 2024 4:30pm" },
    { username: "Inijohn1000", id: "102911120111", amount: "₦10,000", type: "Airtime", status: "Failed", date: "Jan 02, 2024 4:30pm" },
    { username: "Adebayo10", id: "102911120111", amount: "₦10,000", type: "Airtime", status: "Successful", date: "Jan 02, 2024 4:30pm" },
    { username: "Adebayo10", id: "102911120311", amount: "₦10,000", type: "Airtime", status: "Pending", date: "Jan 02, 2024 4:30pm" },
    { username: "Adebayo10", id: "102916120111", amount: "₦10,000", type: "Airtime", status: "Successful", date: "Jan 02, 2024 4:30pm" },
];
                ...
                <div className="flex justify-between items-center my-4 px-6">
                    ...
                    <div className="flex flex-row gap-5 ">
                        ...
                        <div className=" flex flex-row justify-center items-center">
                            <input type="text" placeholder="Search" className=" bg-background-alt border-border rounded-l-[8px] p-4" />
                ...
                <Table className="rounded-2xl bg-background">
                    <TableHeader>
                        <TableRow className="bg-primary-fade text-muted-foreground hover:bg-primary-fade">
                            ...
                            <TableHead className="text-base font-poppins text-text-title">ID</TableHead>
                            ...
                            <TableHead className="text-base font-poppins text-text-title">Date</TableHead>
                    ...
                    <TableBody>
                        {transactions.map((transaction, index) => (
                            <TableRow key={index} className="bg-transparent hover:bg-transparent">
                                ...
                                <TableCell className=" text-text-body font-poppins text-base">{transaction.username}</TableCell>
                                <TableCell className=" text-text-body font-poppins text-base">{transaction.id}</TableCell>
                                <TableCell className=" text-text-body font-poppins text-base">{transaction.amount}</TableCell>
                                <TableCell className=" text-text-body font-poppins text-base">{transaction.type}</TableCell>
                                <TableCell className=" text-text-body font-poppins text-base">
                                    <span
                                        className={`px-2 py-1 rounded-md text-sm font-semibold ${transaction.status === "Successful"
                                            ? "status-success"
                                ...
                                <TableCell className=" text-text-body font-poppins text-base">{transaction.date}</TableCell>
                                <TableCell>
